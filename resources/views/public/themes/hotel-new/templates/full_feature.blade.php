...
<div class="content2 " id="content-2">
    ...
    <div class="post-single container">
        ...
        <div class="row" style="margin: 0 !important; height: 150px">
            <div class="col l5 s12  special-service hide-on-med-and-down">
                ...
                <p class="special-service-description">
                    @if(isset($datas->properties['headline']->title))
                        {!! $datas->properties['headline']->title!!}
                    @endif
                </p>
            </div>
        </div>
        ...
        <div style="margin: 0 !important; height: 160px" class="row">
            <div class="col l6 s12 special-service">
                <p class="post-txt">
...
{{__('layout.room.more information')}}
            ...
            <div class="col l6 s12">
                <div class="check-txt-img special-service">
                    @if(isset($datas->properties['left-content']->title))
                        {!! $datas->properties['left-content']->title !!}
                    @endif
                </div>
            </div>
        </div>
