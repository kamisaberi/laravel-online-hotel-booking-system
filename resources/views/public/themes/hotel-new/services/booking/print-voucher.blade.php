    ...
    <div class="container" style="margin-top: 35px; margin-bottom: 35px;">
        <div class="post-single" style=" ">
            <div id="example-basic">
                ...
                @if($command->title == "open voucher search page")
                    ...
                    <div class="row">
                        <div class="row">
                            ...
                            <div id="right-side-content" class="col l6 s12  right-side-cn " style="padding: 15px !important;">
                                ...
                                <form method="post" action="{{ route('home.services.launch', ['type'=>'print-voucher', 'step'=> 2]) }}">
                                    {{csrf_field()}}
                ...
                @elseif($command->title == "open voucher page")
