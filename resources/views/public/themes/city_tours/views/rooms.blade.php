                        ...
                        <div class="strip_all_tour_list wow fadeIn" data-wow-delay="0.1s">
                            <div class="row">
                                <div class="col-lg-4 col-md-4">
                                    ...
                                    <div class="img_list">
                                        <a href="{{route('home.room.show' , ['id'=>$room->id])}}"><img src="{{asset("front-end-assets/img/hotel_1.jpg")}}" alt="Image">
                                ...
                                <div class="col-lg-2 col-md-2">
                                    <div class="price_list">
                                        <div><sup>$</sup>89*<span class="normal_price_list">$99</span><small>*From/Per night</small>
                                            <p><a href="{{route('home.room.show' , ['id'=>$room->id])}}" class="btn_1">{{__("theme.details")}}</a>
                                            </p>
                                        </div>
                                    </div>
                                </div>
