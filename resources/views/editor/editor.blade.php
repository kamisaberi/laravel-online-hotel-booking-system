...
<html lang="en">
    <head>
        ...
        <link href="{{asset('vvveb/css/editor.css')}}" rel="stylesheet">
        <link href="{{asset('vvveb/css/line-awesome.css')}}" rel="stylesheet">
    </head>
    <body>
        ...
        <div id="vvveb-builder">
            ...
            <div id="top-panel">
                <img src="{{asset('vvveb/img/logo.png')}}" alt="Vvveb" class="float-left" id="logo">


                <div class="btn-group float-left" role="group">
                    <button class="btn btn-light" title="Toggle file manager" id="toggle-file-manager-btn" data-vvveb-action="toggleFileManager" data-toggle="button"
                            aria-pressed="false">
                        <img src="{{asset('vvveb/libs/builder/icons/file-manager-layout.svg')}}" width="20px" height="20px">
                    </button>

                    <button class="btn btn-light" title="Toggle left column" id="toggle-left-column-btn" data-vvveb-action="toggleLeftColumn" data-toggle="button"
                            aria-pressed="false">
                        <img src="{{asset('vvveb/libs/builder/icons/left-column-layout.svg')}}" width="20px" height="20px">
                    </button>

                    <button class="btn btn-light" title="Toggle right column" id="toggle-right-column-btn" data-vvveb-action="toggleRightColumn" data-toggle="button"
                            aria-pressed="false">
                        <img src="{{asset('vvveb/libs/builder/icons/right-column-layout.svg')}}" width="20px" height="20px">
                    </button>
                </div>
                ...
                <div class="btn-group mr-3" role="group">
                    <button class="btn btn-light" title="Designer Mode (Free component dragging)" id="designer-mode-btn" data-toggle="button" aria-pressed="false"
                    ...
                    <div class="header">
                        <ul class="nav nav-tabs" id="elements-tabs" role="tablist">
                            <li class="nav-item component-tab">
                                <a class="nav-link active" id="components-tab" data-toggle="tab" href="#components" role="tab" aria-controls="components" aria-selected="true"><i
                            ...
                            <li class="nav-item blocks-tab">
                                <a class="nav-link" id="blocks-tab" data-toggle="tab" href="#blocks" role="tab" aria-controls="blocks" aria-selected="false"><i
                            ...
                            <li class="nav-item component-properties-tab" style="display:none">
                                <a class="nav-link" id="properties-tab" data-toggle="tab" href="#properties" role="tab" aria-controls="blocks" aria-selected="false"><i
                        ...
                        <div class="tab-content">
                            <div class="tab-pane fade show active" id="components" role="tabpanel" aria-labelledby="components-tab">
                                ...
                                <div class="search">
                                    <input class="form-control form-control-sm component-search" placeholder="Search components" type="text" data-vvveb-action="componentSearch"
                                           data-vvveb-on="keyup">
                            ...
                            <div class="tab-pane fade" id="blocks" role="tabpanel" aria-labelledby="blocks-tab">
                                ...
                                <div class="search">
                                    <input class="form-control form-control-sm block-search" placeholder="Search blocks" type="text" data-vvveb-action="blockSearch"
                                           data-vvveb-on="keyup">
                                        ...
                                        <div class="component-properties">
                                            <ul class="nav nav-tabs nav-fill" id="properties-tabs" role="tablist">
                                                <li class="nav-item content-tab">
                                                    <a class="nav-link active" data-toggle="tab" href="#content-left-panel-tab" role="tab" aria-controls="components"
                                                       aria-selected="true">
                                            ...
                                            <div class="tab-content">
                                                <div class="tab-pane fade show active" id="content-left-panel-tab" data-section="content" role="tabpanel"
                        ...
                        <div id="add-section-box" class="drag-elements">
                            ...
                            <div class="header">
                                <ul class="nav nav-tabs" id="box-elements-tabs" role="tablist">
                                    <li class="nav-item component-tab">
                                        <a class="nav-link active" id="box-components-tab" data-toggle="tab" href="#box-components" role="tab" aria-controls="components"
                                    ...
                                    <li class="nav-item blocks-tab">
                                        <a class="nav-link" id="box-blocks-tab" data-toggle="tab" href="#box-blocks" role="tab" aria-controls="blocks" aria-selected="false"><i
                                                    class="la la-lg la-image"></i>
                                            <div>
                                                <small>Blocks</small>
                                            </div>
                                    ...
                                    <li class="nav-item component-properties-tab" style="display:none">
                                        <a class="nav-link" id="box-properties-tab" data-toggle="tab" href="#box-properties" role="tab" aria-controls="blocks"
                                ...
                                <div class="section-box-actions">
                                    ...
                                    <div class="small mt-1 mr-3 float-right">
                                        ...
                                        <div class="custom-control custom-radio custom-control-inline">
                                            <input type="radio" id="add-section-insert-mode-after" value="after" checked="checked" name="add-section-insert-mode"
                                ...
                                <div class="tab-content">
                                    ...
                                    <div class="tab-pane fade" id="box-blocks" role="tabpanel" aria-labelledby="blocks-tab">
                                        ...
                                        <div class="search">
                                            <input class="form-control form-control-sm block-search" placeholder="Search blocks" type="text" data-vvveb-action="addBoxBlockSearch"
                                                   data-vvveb-on="keyup">
                                            <button class="clear-backspace" data-vvveb-action="clearBlockSearch">
                                                <i class="la la-close"></i>
                                            </button>
            ...
            <script id="vvveb-input-radioinput" type="text/html">
                ...
                <div>
                    ...
                    <label class="custom-control custom-radio  {% if (typeof inline !== 'undefined' && inline == true) { %}custom-control-inline{% } %}"
                        ...
                        <input name="{%=key%}" class="custom-control-input" type="radio" value="{%=options[i].value%}" id="{%=key%}{%=i%}" {%if (options[i].checked) {
            ...
            <script id="vvveb-input-colorinput" type="text/html">
                ...
                <div>
                    <input name="{%=key%}" type="color" {% if (typeof value !== 'undefined' && value != false) { %} value="{%=value%}" {% } %} pattern="#[a-f0-9]{6}"
                    class="form-control"/>
                </div>
            ...
            <script id="vvveb-property" type="text/html">
                ...
                <div class="form-group {% if (typeof col !== 'undefined' && col != false) { %} col-sm-{%=col%} d-inline-block {% } else { %}row{% } %}" data-key="{%=key%}" {% if
                     (typeof group !== 'undefined' && group != null) { %}data-group="{%=group%}" {% } %}>
        ...
        <!-- jquery-->
        <script src="{{asset('vvveb/js/jquery.min.js')}}"></script>
        <script src="{{asset('vvveb/js/jquery.hotkeys.js')}}"></script>

        <!-- bootstrap-->
        <script src="{{asset('vvveb/js/popper.min.js')}}"></script>
        <script src="{{asset('vvveb/js/bootstrap.min.js')}}"></script>

        <!-- builder code-->
        <script src="{{asset('vvveb/libs/builder/builder.js')}}"></script>
        <!-- undo manager-->
        <script src="{{asset('vvveb/libs/builder/undo.js')}}"></script>
        <!-- inputs-->
        <script src="{{asset('vvveb/libs/builder/inputs.js')}}"></script>

        <!-- bootstrap colorpicker //uncomment bellow scripts to enable -->
    <!--
<script src="{{asset('vvveb/libs/bootstrap-colorpicker/js/bootstrap-colorpicker.min.js')}}"></script>
<link href="{{asset('vvveb/libs/bootstrap-colorpicker/css/bootstrap-colorpicker.min.css')}}" rel="stylesheet">
<script src="{{asset('vvveb/libs/builder/plugin-bootstrap-colorpicker.js')}}"></script>
-->

        <!-- components-->
        <script src="{{asset('vvveb/libs/builder/components-server.js')}}"></script>
        <script src="{{asset('vvveb/libs/builder/components-bootstrap4.js')}}"></script>
        <script src="{{asset('vvveb/libs/builder/components-widgets.js')}}"></script>

        <!-- blocks-->
        <script src="{{asset('vvveb/libs/builder/blocks-bootstrap4.js')}}"></script>

        <!-- plugins -->

        <!-- code mirror - code editor syntax highlight -->
        <link href="{{asset('vvveb/libs/codemirror/lib/codemirror.css')}}" rel="stylesheet"/>
        <link href="{{asset('vvveb/libs/codemirror/theme/material.css')}}" rel="stylesheet"/>
        <script src="{{asset('vvveb/libs/codemirror/lib/codemirror.js')}}"></script>
        <script src="{{asset('vvveb/libs/codemirror/lib/xml.js')}}"></script>
        <script src="{{asset('vvveb/libs/codemirror/lib/formatting.js')}}"></script>
        <script src="{{asset('vvveb/libs/builder/plugin-codemirror.js')}}"></script>
        ...
        <script src="{{asset('vvveb/libs/autocomplete/jquery.autocomplete.js')}}"></script>
        ...
        <script>
            $(document).ready(function () {
                ...
                Vvveb.Builder.init("{{asset('vvveb/demo/narrow-jumbotron/index.html')}}", function () {
                    ...
                    [
                        {
                            ...
                            title: "Jumbotron",
                            url: "{{asset('vvveb/demo/narrow-jumbotron/index.html')}}",
                            assets: ["{{asset('vvveb/demo/narrow-jumbotron/narrow-jumbotron.css')}}"]
                        },
                        {
                            name: "landing-page",
                            title: "Landing page",
                            url: "{{asset('vvveb/demo/startbootstrap-landing-page/index.html')}}",
                            assets: ["{{asset('vvveb/demo/startbootstrap-landing-page/css/landing-page.min.css')}}"]
                        },
                        {
                            name: "album",
                            title: "Album",
                            url: "{{asset('vvveb/demo/album/index.html')}}",
                            assets: ["{{asset('vvveb/demo/album/album.css')}}"]
                        },
                        {
                            name: "blog",
                            title: "Blog",
                            url: "{{asset('vvveb/demo/blog/index.html')}}",
                            assets: ["{{asset('vvveb/demo/blog/blog.css')}}"]
                        },
                        {
                            name: "carousel",
                            title: "Carousel",
                            url: "{{asset('vvveb/demo/carousel/index.html')}}",
                            assets: ["{{asset('vvveb/demo/carousel/carousel.css')}}"]
                        },
                        {
                            name: "offcanvas",
                            title: "Offcanvas",
                            url: "{{asset('vvveb/demo/offcanvas/index.html')}}",
                            assets: ["{{asset('vvveb/demo/offcanvas/offcanvas.css','demo/offcanvas/offcanvas.js')}}"]
                        },
                        {
                            name: "pricing",
                            title: "Pricing",
                            url: "{{asset('vvveb/demo/pricing/index.html')}}",
                            assets: ["{{asset('vvveb/demo/pricing/pricing.css')}}"]
                        },
                        {
                            name: "product",
                            title: "Product",
                            url: "{{asset('vvveb/demo/product/index.html')}}",
                            assets: ["{{asset('vvveb/demo/product/product.css')}}"]
                        },
                        {
                            name: "ecommerce",
                            title: "eCommerce homepage",
                            url: "{{asset('vvveb/demo/essence/index.html')}}",
                            config: "{{asset('vvveb/demo/essence/vvvebjs.json')}}"
                        },
                        {
                            name: "test",
                            title: "test",
                            url: "http://vvveb_install.givan.ro/"
                        },
                    ]);
