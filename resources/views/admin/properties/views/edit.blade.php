                                                ...
                                                <div class="row">
                                                    <div class="col-md-6 col-sm-12">
                                                        <div class="form-group">
                                                            ...
                                                            <input class="form-control" id="title" name="title" type="text" value="{{$property->title}}">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <select class="form-control" id="level" name="level">
                                                                ...
                                                                @foreach(trans('messages.levels') as $k=>$v)
                                                                    <option value="{{$k}}" {{$property->level == $k ? 'selected' : ''}}>{{$v}}</option>
                                                                @endforeach
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <select class="form-control" id="input_type" name="input_type">
                                                                ...
                                                                @foreach(trans('messages.input_types') as $k=>$v)
                                                                    <option value="{{$k}}" {{$property->input_type ==$k ? 'selected' : '' }}>{{$v}}</option>
                                                                @endforeach
...
@section("footer")
    ...
    <script src="{{asset('admin-assets/js/scripts/mine/items.js')}}" type="text/javascript"></script>
    <script>

        var input_type = '{{$property->input_type}}';
        ...
        $(document).ready(function () {
            ...
            $('#input_type').change(function () {
                ...
                if ($(this).val() === 'text') {
                    ...
                    $('#default_value_col').html(`<div class="form-group"> <label for="default_value">مقدار پیش فرض</label><input class="form-control" id="default_value" name="default_value" type="text" value="${default_value}"></div>`);

                } else if ($(this).val() === 'check') {

                    $('#default_value_col').html(`<label><input id="default_value" name="default_value" ${default_value == 1 ? 'checked' : ''} type="checkbox" class="filled-in" /><span>مقدار پیش فرض</span></label>`);
            ...
            $('#input_type').trigger('change'); //This event will fire the change event.
