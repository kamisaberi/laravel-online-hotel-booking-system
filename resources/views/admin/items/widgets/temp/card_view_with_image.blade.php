    ...
    <div class="card">
        <div class="card-content">
            ...
            @foreach($data->properties[3] as $p)
                @if(isset($p->assigned[0]->value))
                    <img class="img-fluid" src="{{$p->assigned[0]->thumbs['480x360']}}" alt="Card image cap">
                @else
                    <img class="img-fluid" src="{{asset('uploads/480x360/room-020.jpg')}}" alt="Card image cap">
                @endif
            @endforeach
